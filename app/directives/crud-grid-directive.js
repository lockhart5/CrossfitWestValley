app.directive('crudProductGrid', function () {
    return {
        restrict: 'A',
        replace: false,
        scope: true,
        templateUrl: '/App/Directives/Templates/crud-grid-directive-product.html',
        controller: ['$scope', '$element', '$attrs', 'crudGridDataFactory', 'notificationFactory',
            function ($scope, $element, $attrs, crudGridDataFactory, notificationFactory) {
                ...
                $scope.deleteObject = function (object) {
                    crudGridDataFactory($attrs.tableName).delete({ id: object.productID }, successCallback, errorCallback);
                };
